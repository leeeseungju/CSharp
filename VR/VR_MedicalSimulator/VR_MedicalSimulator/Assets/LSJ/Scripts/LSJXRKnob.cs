...
namespace UnityEngine.XR.Content.Interaction
{
    ...
    /// </summary>
    public class LSJXRKnob : XRBaseInteractable
    {
        ...
        void UpdateRotation(bool freshCheck = false)
        {
            ...
            // Adjust object's rotation to match the knob rotation
            // Assuming both the knob and the object rotate around the Z-axis
            if (m_Handle != null)
            {
                m_Handle.localEulerAngles = new Vector3(-90.0f, 0.0f, -knobRotation); // Adjust the rotation accordingly
            }
        }
        void SetKnobRotation(float angle)
        {
            ...
            if (m_Handle != null)
                m_Handle.localEulerAngles = new Vector3(-90.0f, angle, 0.0f);
        }
