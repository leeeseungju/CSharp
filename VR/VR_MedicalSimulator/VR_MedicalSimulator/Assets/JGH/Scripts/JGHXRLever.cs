...
namespace UnityEngine.XR.Content.Interaction
{
    ...
    /// </summary>
    public class JGHXRLever : XRBaseInteractable
    {
        ...
        {
            if (m_Handle != null)
                m_Handle.localRotation = Quaternion.Euler(-90f, angle, 0.0f);
        }
        ...
        void OnDrawGizmosSelected()
        {
            ...
            var angleMaxPoint = angleStartPoint + transform.TransformDirection(Quaternion.Euler(0f, m_MaxAngle, 0.0f) * Vector3.up) * k_AngleLength;
            var angleMinPoint = angleStartPoint + transform.TransformDirection(Quaternion.Euler(0f, m_MinAngle, 0.0f) * Vector3.up) * k_AngleLength;
